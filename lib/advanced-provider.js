...
const API_URL = 'https://raw.githubusercontent.com/Baiyun-u-smartAI/atom-autocomplete-boilerplate/master/data/advanced.json';
...
class AdvancedProvider {
	...
	inflateSuggestion(replacementPrefix, suggestion) {
		var HTML_str='<span class="aab-right-label">'+suggestion.description+' Snippet</span>';
		return {
			...
			type: 'snippet',
			rightLabelHTML: HTML_str // look in /styles/atom-slds.less
		};
	}
